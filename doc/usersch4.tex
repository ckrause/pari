...
\item a table of primes, called \teb{pari_PRIMES}, of type \kbd{pari\_prime*}
...
\fun{GEN}{gp_read_str_bitprec}{const char *s, long bitprec} DEPRECATED, use
\kbd{gp\_read\_str\_prec}.
