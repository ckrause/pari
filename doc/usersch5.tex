...
In both case, the arity of the closure need to match the number of \kbd{V}
appearing before the code \kbd{I}, \kbd{E} or \kbd{J} in the prototype.
...
an pseudo-inline closure suitable to use with the prototype codes \kbd{I} and
\kbd{E}.
