...
$P=a\prod_{i=1}^m(x-p_i)$ and $Q=b\prod_{j=1}^n(x-q_j)$ in some suitable algebraic extenstion,
return $a^n\*b^m\prod_{i,j}(x-(p_i+q_j))$.
...
$P=a\prod_i(x-p_i)$ and $Q=b\prod_j(x-q_j)$ in some suitable algebraic extenstion,
return $a\*b\prod_{i,j}(x-(p_i+q_j))$.
