...
\fun{GEN}{RgM_Cholesky}{GEN M} given a square symmetric \typ{MAT} $M$, return $R$
such that $^t{}R\*R = M$, or \kbd{NULL} is no solutions are found, if $M$ is not
positive or was given with insufficient accuracy.
