...
restrictions as \tet{gc_upto}, the only difference being that more than
...
\fun{GEN}{addrr[z]}{GEN x, GEN y[, GEN z]} followed by the explicit
description of the function

\fun{GEN}{addrr}{GEN x, GEN y}
...
\fun{void}{addrrz}{GEN x, GEN y, GEN z}
