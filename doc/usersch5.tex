...
variant of \tet{gc_all}, about twice faster.
...
\kbd{avma} and \kbd{ltop}. To be used in the
following scenario:
\bprog
  GEN f(..., GEN *py)
  {
...
\kbd{gc_all_unsafe}, of which this is a variant. For instance
\bprog
  z = cgetg(3, t_COMPLEX);
...
\kbd{gc\_INT} and \kbd{gerepileupto}, \kbd{gerepileuptoleaf} leaves
