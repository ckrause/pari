...
\fun{GEN}{ec_bmodel}{GEN E, long v} returns the polynomial $4x^3 + b_2x^2 + 2b_4x +
b_6$ in the variable \kbd{v}.
...
as \kbd{FpXQ\_ellcard\_supersingular} but allows \kbd{T=NULL}.
